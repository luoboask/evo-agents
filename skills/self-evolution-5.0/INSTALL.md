...
```bash
# 检查技能目录
ls -la ~/.openclaw/workspace/skills/self-evolution-5.0/
...
```bash
~/.openclaw/workspace/skills/self-evolution-5.0/config.yaml
```
...
```
~/.openclaw/workspace/skills/self-evolution-5.0/
├── main.py                 # 主入口
├── install.py              # 安装脚本
├── config.yaml             # 配置文件
