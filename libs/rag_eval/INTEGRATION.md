...
**文件**: `libs/rag_eval/test_integration.py`
...
**运行**:
```bash
python3 libs/rag_eval/test_integration.py
```
...
# 过去 30 天
python3 libs/rag_eval/evaluate.py --report --days 30
```
...
**解决**: 首次运行时会自动创建，或手动创建 `libs/rag_eval/logs/` 目录。
...
有任何问题，查看 `libs/rag_eval/USAGE.md` 或运行 `--help`。
