...
if [ "$LANG" = "zh" ]; then
    ...
    if command -v ollama &> /dev/null; then
        ...
        if [[ "$INSTALL_MODEL" =~ ^[Yy]$ ]]; then
            ...
            echo ""
            echo "【英文模型】"
            echo "  1) nomic-embed-text (通用，~0.5GB) - 平衡性能和大小"
            echo "  2) mxbai-embed-large (高性能，~0.7GB) - 复杂查询最佳"
            echo "  3) all-minilm (轻量，~0.2GB) - 最小最快"
            echo "  4) snowflake-arctic-embed (多语言，~0.5GB) - 多语言场景"
            echo ""
            echo "【中文模型】"
            echo "  5) bge-m3 (最佳，~2.3GB) - 中文 + 多语言，效果最好"
            echo "  6) m3e (轻量，~0.5GB) - 中文快速搜索"
            echo "  7) bge-large-zh (专用，~1.3GB) - 中文复杂查询"
            echo ""
            echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
            echo ""
